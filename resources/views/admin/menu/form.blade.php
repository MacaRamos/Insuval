<div class="col-lg-8 mx-auto">
    <div class="form-group row">
        ...
        <div class="col-lg-8">
        <input type="text" name="Men_nombre" class="form-control" id="Men_nombre" value="{{old('Men_nombre')}}" required/>
        </div>
    </div>
    <div class="form-group row">
        <label for="Men_url" class="col-lg-3 col-form-label requerido">Url</label>
        <div class="col-lg-8">
        <input type="text" name="Men_url" class="form-control" id="Men_url" value="{{old('Men_url')}}" required/>
        </div>
    </div>
    <div class="form-group row">
